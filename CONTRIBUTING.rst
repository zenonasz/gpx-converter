...
gpx_converter could always use more documentation, whether as part of the
official gpx_converter docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `gpx_converter` repo on GitHub.
...
3. The pull request should work for Python 3.5, 3.6, 3.7 and 3.8, and for PyPy. Check
   https://travis-ci.com/nidhaloff/gpx_converter/pull_requests
...
$ pytest tests.test_gpx_converter
